...
class DDPG():
    def __init__(self, model, learning_rate, reward_decay=0.98, replace_target_iter=300,
                 memory_size=5000, batch_size=64, tau=0.01, epsilon_params=None,  # init var / final var / decay
        ...
        self.epsilon_params = [1.0, 0.5, 0.00001]
