...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_inputimage_4.setGeometry(QtCore.QRect(160, 150, 800, 700))
        font = QtGui.QFont()
        ...
        self.label_inputimage_18 = QtWidgets.QLabel(self.page_4)
        self.label_inputimage_18.setGeometry(QtCore.QRect(90, 500, 300, 400))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_inputimage_19 = QtWidgets.QLabel(self.page_4)
        self.label_inputimage_19.setGeometry(QtCore.QRect(430, 180, 860, 640))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.pushButton_image_17 = QtWidgets.QPushButton(self.page_5)
        self.pushButton_image_17.setGeometry(QtCore.QRect(1160, 40, 141, 81))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.pushButton_image_17.setFont(font)
        self.pushButton_image_17.setObjectName("pushButton_image_17")
        self.label_input_6 = QtWidgets.QLabel(self.page_5)
        self.label_input_6.setEnabled(True)
        self.label_input_6.setGeometry(QtCore.QRect(880, 100, 431, 41))
        ...
        self.textBrowser_image_2 = QtWidgets.QTextBrowser(self.page_5)
        self.textBrowser_image_2.setGeometry(QtCore.QRect(550, 140, 301, 101))
        self.textBrowser_image_2.setObjectName("textBrowser_image_2")
        self.pushButton_image_18 = QtWidgets.QPushButton(self.page_5)
        self.pushButton_image_18.setGeometry(QtCore.QRect(60, 60, 191, 41))
        self.pushButton_image_18.setObjectName("pushButton_image_18")
        self.label_input_7 = QtWidgets.QLabel(self.page_5)
        self.label_input_7.setEnabled(True)
        self.label_input_7.setGeometry(QtCore.QRect(870, 20, 101, 41))
        ...
        self.label_input_8 = QtWidgets.QLabel(self.page_5)
        self.label_input_8.setEnabled(True)
        self.label_input_8.setGeometry(QtCore.QRect(550, 100, 301, 41))
        self.label_input_8.setLayoutDirection(QtCore.Qt.LeftToRight)
        ...
        self.pushButton_image_19 = QtWidgets.QPushButton(self.page_5)
        self.pushButton_image_19.setGeometry(QtCore.QRect(260, 60, 191, 41))
        self.pushButton_image_19.setObjectName("pushButton_image_19")
        self.textBrowser_image_3 = QtWidgets.QTextBrowser(self.page_5)
        self.textBrowser_image_3.setGeometry(QtCore.QRect(880, 140, 431, 761))
        self.textBrowser_image_3.setObjectName("textBrowser_image_3")
        self.pushButton_image_20 = QtWidgets.QPushButton(self.page_5)
        self.pushButton_image_20.setGeometry(QtCore.QRect(460, 60, 191, 41))
        self.pushButton_image_20.setObjectName("pushButton_image_20")
        self.label_input_9 = QtWidgets.QLabel(self.page_5)
        self.label_input_9.setEnabled(True)
        self.label_input_9.setGeometry(QtCore.QRect(60, 100, 471, 41))
        ...
        self.label_input_10 = QtWidgets.QLabel(self.page_5)
        self.label_input_10.setEnabled(True)
        self.label_input_10.setGeometry(QtCore.QRect(60, 10, 291, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_input_10.setFont(font)
        ...
        self.comboBox_2.setGeometry(QtCore.QRect(850, 60, 141, 41))
        self.comboBox_2.setSizeIncrement(QtCore.QSize(0, 14))
        ...
        self.pushButton_image_21 = QtWidgets.QPushButton(self.page_5)
        self.pushButton_image_21.setGeometry(QtCore.QRect(660, 60, 181, 41))
        self.pushButton_image_21.setObjectName("pushButton_image_21")
        self.pushButton_image_22 = QtWidgets.QPushButton(self.page_5)
        self.pushButton_image_22.setGeometry(QtCore.QRect(1000, 60, 121, 41))
        self.pushButton_image_22.setObjectName("pushButton_image_22")
        self.label_inputimage_8 = QtWidgets.QLabel(self.page_5)
        self.label_inputimage_8.setGeometry(QtCore.QRect(50, 140, 480, 380))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_inputimage_17 = QtWidgets.QLabel(self.page_5)
        self.label_inputimage_17.setGeometry(QtCore.QRect(539, 279, 331, 621))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.label_inputimage_17.setFont(font)
        self.label_inputimage_17.setAutoFillBackground(True)
        self.label_inputimage_17.setFrameShadow(QtWidgets.QFrame.Plain)
        self.label_inputimage_17.setText("")
        self.label_inputimage_17.setObjectName("label_inputimage_17")
        self.label_inputimage_16 = QtWidgets.QLabel(self.page_5)
        self.label_inputimage_16.setGeometry(QtCore.QRect(50, 529, 471, 371))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.label_inputimage_16.setFont(font)
        self.label_inputimage_16.setAutoFillBackground(True)
        self.label_inputimage_16.setFrameShadow(QtWidgets.QFrame.Plain)
        self.label_inputimage_16.setText("")
        self.label_inputimage_16.setObjectName("label_inputimage_16")
        self.label_input_11 = QtWidgets.QLabel(self.page_5)
        self.label_input_11.setEnabled(True)
        self.label_input_11.setGeometry(QtCore.QRect(530, 240, 341, 41))
        ...
        self.label_inputimage_3.setGeometry(QtCore.QRect(190, 180, 800, 700))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        font.setBold(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_image_5.setText(_translate("MainWindow", "5. VGG16 Classifier"))
...
""))
        ...
        self.pushButton_image_17.setText(_translate("MainWindow", "HOME"))
        self.label_input_6.setText(_translate("MainWindow", "Model Structure"))
        self.pushButton_image_18.setText(_translate("MainWindow", "5.1 Show Training Images"))
        self.label_input_7.setText(_translate("MainWindow", "Select Image"))
        self.label_input_8.setText(_translate("MainWindow", "Training Hyperparameters"))
        self.pushButton_image_19.setText(_translate("MainWindow", "5.2 Show Hyperparameters"))
        self.pushButton_image_20.setText(_translate("MainWindow", "5.3 Show Model Structure"))
        self.label_input_9.setText(_translate("MainWindow", "Training Image"))
        self.label_input_10.setText(_translate("MainWindow", "5. Cifar10 Classifier Using VGG16"))
        self.pushButton_image_21.setText(_translate("MainWindow", "5.4 Show Accuracy"))
        self.pushButton_image_22.setText(_translate("MainWindow", "5.5 Test"))
        self.label_input_11.setText(_translate("MainWindow", "Predict Output"))
